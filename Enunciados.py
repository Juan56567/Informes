diagnostico = {
    ...
    "rectificar": {
        "cromar": "Cromar: Tras un análisis exhaustivo, se ha determinado la necesidad imperante de someter la pieza a un proceso de cromado debido a la presencia significativa de rallas o imperfecciones en su superficie. El trabajo del cilindro ha ocasionado un deterioro progresivo y visible en la estructura metálica de la pieza, comprometiendo tanto su resistencia como su funcionalidad.",
        "brillar": "Brillar: Una vez finalizado el minucioso proceso de diagnóstico de la pieza, se ha determinado que es necesario llevar a cabo un procedimiento de pulido con el fin de restaurar su acabado original, eliminar cualquier imperfección superficial y mejorar significativamente su apariencia estética. Mediante este proceso de pulido, se aplicarán técnicas especializadas para eliminar cualquier rastro de desgaste, marcas o defectos que puedan haberse manifestado debido a condiciones de uso, daños externos o desgaste natural",
        "brunir": "Bruñir: Luego de un minucioso diagnóstico, se determina que es indispensable llevar a cabo el proceso de bruñido en la pieza en cuestión. Esta acción se hace necesaria para eliminar las irregularidades y asperezas presentes en su superficie, las cuales afectan de manera directa tanto la funcionalidad como la durabilidad del componente. El bruñido, mediante la utilización de abrasivos finos y técnicas de pulido específicas, permitirá obtener una superficie lisa, uniforme y libre de imperfecciones, restableciendo así las condiciones óptimas de deslizamiento",
        "deformacion": "Deformación: Se ha determinado la necesidad de realizar la rectificación de la pieza debido a la presencia de deformación. Esta deformación, detectada mediante análisis dimensional y pruebas exhaustivas, ha comprometido la geometría y la precisión requeridas para el correcto funcionamiento de la pieza.",
        "rosca": "Rosca: Tras realizar una evaluación detallada, se ha identificado que la rosca de la pieza presenta irregularidades y dimensiones fuera de tolerancia. Estas condiciones inadecuadas afectan negativamente la funcionalidad y seguridad del ensamblaje al que pertenece.",
    },
}
